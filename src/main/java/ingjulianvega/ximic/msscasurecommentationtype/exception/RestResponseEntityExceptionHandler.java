...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(value = {RecommendationTypeException.class})
    protected ResponseEntity<Object> handleConflict(RecommendationTypeException ex, WebRequest request) {
