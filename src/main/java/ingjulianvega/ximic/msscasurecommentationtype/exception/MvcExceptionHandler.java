...
import ingjulianvega.ximic.msscasurecommentationtype.configuration.RecommendationTypeParameters;
...
public class MvcExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public MvcExceptionHandler(RecommendationTypeParameters recommendationTypeParameters) {
        this.recommendationTypeParameters = recommendationTypeParameters;
    }

    RecommendationTypeParameters recommendationTypeParameters;


    @ExceptionHandler(RecommendationTypeException.class)
    public ResponseEntity<ApiError> validationErrorHandler(RecommendationTypeException ame) {
        ApiError apiError = ApiError
                .builder()
                .timestamp(LocalDateTime.now())
                .api(recommendationTypeParameters.getApi())
